...
const images = [
  ...
  {url : slider[0], type : 'img',link:'https://www.usgbc.org/events/',caption : [{
  ...
  {url : slider[1],  type : 'img',link:'https://www.usgbc.org/events/',caption : [{
    txt:"EVENT - Apr 20, 2020 at 1:00 PM UEDT",
    css:"small"
  },
  {
  ...
  {url : slider[2], type : 'img',link:'https://www.usgbc.org/events/',caption : [{
  ...
  {url : slider[3],  type : 'img',link:'https://www.usgbc.org/events/',caption : [{
  ...
  {url : slider[4],  type : 'img',link:'https://www.usgbc.org/events/',caption : [{
  ...
  {url : slider[5],  type : 'img',link:'https://www.usgbc.org/events/',caption : [{
    txt:"EVENT - Apr 20, 2020 at 1:00 PM UEDT",
    css:"small"
  },
  {
  ...
  {url : slider[6],  type : 'img',link:'https://www.usgbc.org/events/',caption : [{
  ...
  {url : slider[7],  type : 'img',link:'https://www.usgbc.org/events/',caption : [{
  ...
  {url : slider[8],  type : 'img',link:'https://www.usgbc.org/events/',caption : [{
  ...
  {url : slider[9],  type : 'img',link:'https://www.usgbc.org/events/',caption : [{
